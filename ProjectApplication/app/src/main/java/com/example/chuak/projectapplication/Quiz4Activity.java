...
public class Quiz4Activity extends Activity {
    ...
    private Quiz4Question mQuestionLibrary = new Quiz4Question();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreView = findViewById(R.id.score4);
        mQuestionView = findViewById(R.id.question4);
        mButtonChoice1 = findViewById(R.id.choice41);
        mButtonChoice2 = findViewById(R.id.choice42);
        mButtonChoice3 = findViewById(R.id.choice43);
        mButtonChoice4 = findViewById(R.id.choice44);

        quitButton = findViewById(R.id.quit_button4);
        ...
        if (mQuestionNumber < mQuestionLibrary.getLength()) {
            ...
            new android.os.Handler().postDelayed(
                    new Runnable() {
                        public void run() {
                            mQuestionLibrary.clearQuestion();
                            Intent intent = new Intent(Quiz4Activity.this, HighestScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)) {
            mScore = mScore + 1;
            Crouton.makeText(Quiz4Activity.this, "Correct!", Style.CONFIRM).show();
        } else {
